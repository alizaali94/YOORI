                ...
                <div class="col-sm-xs-12 col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex middle">
                            <a href="{{ route('admin.list.download','category') }}" target="_blank" class="btn btn-outline-info p-4 mt-4 mr-1 sample-download"><i class="bx bx-download"></i> {{ __('Categories') }}</a>
                            <a href="{{ route('admin.list.download','brand') }}" target="_blank" class="btn btn-outline-info p-4 mt-4 ml-1 sample-download"><i class="bx bx-download"></i> {{ __('Brands') }}</a>
                        </div>
                    </div>
                </div>
            </div>
