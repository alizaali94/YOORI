    ...
    !function (a) {
        ...
        var l = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;", "`": "&#x60;"},
            ...
            n = function (a) {
                ...
                104: "8",
                105: "9"
            }, r = {ESCAPE: 27, ENTER: 13, SPACE: 32, TAB: 9, ARROW_UP: 38, ARROW_DOWN: 40}, s = {};
        ...
        var t = {
            ...
            }, u = new RegExp(r.ARROW_UP + "|" + r.ARROW_DOWN), v = new RegExp("^" + r.TAB + "$|" + r.ESCAPE),
        ...
        w.VERSION = "1.13.0-beta", w.DEFAULTS = {
            ...
            windowPadding: 0,
            virtualScroll: 600
        }, "4" === s.major && (w.DEFAULTS.style = "btn-lights", w.DEFAULTS.iconBase = "", w.DEFAULTS.tickIcon = "bs-ok-default"), w.prototype = {
            constructor: w, init: function () {
                ...
                w.each(function (k) {
                    ...
                    if (j++, !l.hasClass("bs-title-option")) {
                        var m, s, u = l.data(), v = this.className || "", x = o(this.style.cssText), y = u.content,
                            z = this.textContent, A = u.tokens, B = u.subtext, C = u.icon, D = l.parent(), E = D[0],
                        ...
                        if (F && !0 !== u.divider) {
                            ...
                            if (!this.previousElementSibling) {
                                h += 1;
                                var N = E.label, O = o(N), P = J.subtext, Q = J.icon;
                ...
                var b = this, c = this.$element.find("option"), d = [], e = [];
                ...
                if (b || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var r, u = k.offsetHeight, v = i ? i.offsetHeight : 0, w = m ? m.offsetHeight : 0,
                        x = n ? n.offsetHeight : 0, y = o ? o.offsetHeight : 0, z = p ? p.offsetHeight : 0,
                        A = a(h).outerHeight(!0), B = !!window.getComputedStyle && window.getComputedStyle(e),
                        C = e.offsetWidth, D = B ? null : a(e), E = {
                ...
                c.data("spaceSelect", !1), this.$button.on("keyup", function (a) {
                    ...
                    var e = a(this), f = b.isVirtual() ? b.selectpicker.view.position0 : 0,
                        g = b.selectpicker.current.map.originalIndex[e.parent().index() + f], h = b.$element.val(),
                        i = b.$element.prop("selectedIndex"), k = !0;
                    if (b.multiple && 1 !== b.options.maxOptions && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !e.parent().hasClass(t.DISABLED)) {
                        var l = b.$element.find("option"), m = l.eq(g), n = m.prop("selected"),
                            o = m.parent("optgroup"), p = b.options.maxOptions, q = o.data("maxOptions") || !1;
                        if (b.multiple) {
                            if (m.prop("selected", !n), g === b.activeIndex && (d = !0), d || (b.prevActiveIndex = b.activeIndex, b.activeIndex = void 0), b.setSelected(g, !n), e.blur(), !1 !== p || !1 !== q) {
                                var r = p < l.filter(":selected").length, s = q < o.find("option:selected").length;
                                if (p && r || q && s) if (p && 1 == p) l.prop("selected", !1), m.prop("selected", !0), b.$menuInner.find(".selected").removeClass("selected"), b.setSelected(g, !0); else if (q && 1 == q) {
                                    ...
                                    var v = "string" == typeof b.options.maxOptionsText ? [b.options.maxOptionsText, b.options.maxOptionsText] : b.options.maxOptionsText,
                                        w = "function" == typeof v ? v(p, q) : v, x = w[0].replace("{n}", p),
                                        y = w[1].replace("{n}", q), z = a('<div class="notify"></div>');
                ...
                this.$button.on("click.bs.dropdown.data-api", function () {
                    ...
                    if (a.selectpicker.search.map.newIndex = {}, a.selectpicker.search.map.originalIndex = {}, a.selectpicker.search.elements = [], a.selectpicker.search.data = [], d) {
                        var e, f = [], g = d.toUpperCase(), h = {}, i = [], j = a._searchStyle(),
                        ...
                        for (var e = 0, m = i.length; e < m; e++) {
                            var n = i[e], p = i[e - 1], l = a.selectpicker.main.data[n],
                ...
                if (this.multiple) {
                    ...
                    for (var b = this.$element.find("option"), c = 0, d = 0, e = 0; e < this.selectpicker.current.elements.length; e++) {
                        var f = this.selectpicker.current.map.originalIndex[e], g = b[f];
                ...
                var d, e, f, g, h, i = a(this), j = i.is("input") ? i.parent().parent() : i.parent(),
                    k = j.data("this"), l = k.findLis(), m = !1,
                    n = b.which === r.TAB && !i.hasClass("dropdown-toggle") && !k.options.selectOnTab,
                    o = u.test(b.which) || n, p = k.$menuInner[0].scrollTop, s = k.isVirtual(),
