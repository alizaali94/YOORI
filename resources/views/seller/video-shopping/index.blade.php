                            ...
                            <table class="table table-striped table-md">
                                ...
                                @foreach ($videos as $key=>$video)
                                    <tr id="row_{{ $video->id }}" class="table-data-row">
                                        ...
                                        <td>
                                            <label class="custom-switch mt-2 cursor-not-allowed">
                                                <input type="checkbox" name="custom-switch-checkbox" value="video-shopping-status-change/{{$video->id}}"
                                                       {{ $video->status == 1 ? 'checked' : '' }} class="status-change custom-switch-input">
                                                <span class="custom-switch-indicator"></span>
                                            </label>
                                        </td>
                                        <td>
                                            <a href="{{ route('seller.video.shopping.edit',$video->id) }}" class="btn btn-outline-secondary btn-circle" data-url=""data-toggle="tooltip" title="" data-original-title="{{ __('Edit') }}">
            ...
            <div class="col-sm-xs-12 col-md-5">
                    <div class="card" >
                        ...
                        <div class="card-body card-body-paddding">
                            <form method="POST" action="{{ route('seller.shopping.video.store') }}" enctype="multipart/form-data">
                                @csrf
